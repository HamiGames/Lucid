...
TEMPLATE_FILE="$CONFIG_DIR/env.gui_api_bridge.template"
...
SERVICE_NAME=gui_api_bridge
SERVICE_VERSION=1.0.0
HOST=0.0.0.0
PORT=8102
SERVICE_URL=http://lucid-gui_api_bridge:8102
...
# SSL Configuration
SSL_ENABLED=false
SSL_CERT_PATH=/etc/ssl/certs/gui_api_bridge.crt
SSL_KEY_PATH=/etc/ssl/private/gui_api_bridge.key
...
echo "  4. Run: docker-compose up -d lucid-gui_api_bridge"
echo ""
