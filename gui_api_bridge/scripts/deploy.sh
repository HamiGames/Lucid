...
# File: gui_api_bridge/scripts/deploy.sh
...
docker-compose -f "$DOCKER_COMPOSE_FILE" up -d lucid-gui_api_bridge
...
if [ $timeout -le 0 ]; then
    ...
    echo "Showing logs:"
    docker-compose logs lucid-gui_api_bridge
    exit 1
fi
...
echo ""
echo "View logs: docker-compose logs -f lucid-gui_api_bridge"
echo ""
