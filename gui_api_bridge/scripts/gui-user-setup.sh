#!/bin/bash
# ========================================================================
# File: /app/gui_api_bridge/scripts/gui-user-setup.sh
# x-lucid-file-path: /app/gui_api_bridge/scripts/gui-user-setup.sh
...
GUI_BRIDGE_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)/lucid/gui_api_bridge/scripts" 2>/dev/null || \
              /opt/lucid/gui_api_bridge/scripts
