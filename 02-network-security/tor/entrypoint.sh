#!/usr/bin/env bash
# tor_entrypoint.sh — Tor Proxy Container Entrypoint v4.1.0
...
# Cascade: od (primary) → pure bash byte loop.
...
# Generated by tor_entrypoint.sh v4.1.0 — do not edit directly.
