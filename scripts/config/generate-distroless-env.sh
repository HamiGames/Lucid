...
LUCID_GUI_SUBNET=172.27.0.0/16
LUCID_GUI_GATEWAY=172.27.0.1

# Distroless Production Network
LUCID_DISTROLESS_PROD_NETWORK=lucid-distroless-production
LUCID_DISTROLESS_PROD_SUBNET=172.28.0.0/16
LUCID_DISTROLESS_PROD_GATEWAY=172.28.0.1

# Distroless Development Network
LUCID_DISTROLESS_DEV_NETWORK=lucid-distroless-dev
LUCID_DISTROLESS_DEV_SUBNET=172.29.0.0/16
LUCID_DISTROLESS_DEV_GATEWAY=172.29.0.1

# Multi-Stage Build Network
LUCID_MULTI_STAGE_NETWORK=lucid-multi-stage-network
LUCID_MULTI_STAGE_SUBNET=172.30.0.0/16
LUCID_MULTI_STAGE_GATEWAY=172.30.0.1
