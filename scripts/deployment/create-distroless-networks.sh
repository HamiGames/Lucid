...
DISTROLESS_PROD_SUBNET="172.28.0.0/16"
DISTROLESS_PROD_GATEWAY="172.28.0.1"

DISTROLESS_DEV_NETWORK="lucid-distroless-dev"
DISTROLESS_DEV_SUBNET="172.29.0.0/16"
DISTROLESS_DEV_GATEWAY="172.29.0.1"

MULTI_STAGE_NETWORK="lucid-multi-stage-network"
MULTI_STAGE_SUBNET="172.30.0.0/16"
MULTI_STAGE_GATEWAY="172.30.0.1"
