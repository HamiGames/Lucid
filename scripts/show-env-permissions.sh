...
# File: /app/scripts/show-env-permissions.sh
# x-lucid-file-path: /app/scripts/show-env-permissions.sh
...
# Base path: LUCID_REPO_ROOT / configs/environment (host checkout); image layout: /app/configs
#
# =============================================================================
