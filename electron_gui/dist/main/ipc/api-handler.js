...
exports.setupApiHandlers = void 0;
const electron_1 = require("electron");
const ipc_channels_1 = require("../../shared/ipc-channels");
function setupApiHandlers(windowManager) {
    console.log('Setting up API proxy IPC handlers...');
    // Generic API request handler
    electron_1.ipcMain.handle(ipc_channels_1.RENDERER_TO_MAIN_CHANNELS.API_REQUEST, async (event, request) => {
        try {
    ...
    // GET request handler
    electron_1.ipcMain.handle(ipc_channels_1.RENDERER_TO_MAIN_CHANNELS.API_GET, async (event, { url, headers = {}, timeout = 30000 }) => {
        try {
    ...
    electron_1.ipcMain.handle(ipc_channels_1.RENDERER_TO_MAIN_CHANNELS.API_POST, async (event, { url, data, headers = {}, timeout = 30000 }) => {
        try {
    ...
    // PUT request handler
    electron_1.ipcMain.handle(ipc_channels_1.RENDERER_TO_MAIN_CHANNELS.API_PUT, async (event, { url, data, headers = {}, timeout = 30000 }) => {
        try {
    ...
    electron_1.ipcMain.handle(ipc_channels_1.RENDERER_TO_MAIN_CHANNELS.API_DELETE, async (event, { url, headers = {}, timeout = 30000 }) => {
        try {
    ...
    // File upload handler
    electron_1.ipcMain.handle(ipc_channels_1.RENDERER_TO_MAIN_CHANNELS.API_UPLOAD, async (event, { url, filePath, formData, headers = {}, timeout = 60000 }) => {
        try {
    ...
    electron_1.ipcMain.handle(ipc_channels_1.RENDERER_TO_MAIN_CHANNELS.API_DOWNLOAD, async (event, { url, savePath, headers = {}, timeout = 60000 }) => {
        try {
...
exports.setupApiHandlers = setupApiHandlers;
// Helper function to make API requests through Tor
async function makeApiRequest(method, url, data, headers = {}, timeout = 30000) {
    try {
...
async function makeFileUploadRequest(url, filePath, formData, headers = {}, timeout = 60000) {
    try {
...
async function makeFileDownloadRequest(url, savePath, headers = {}, timeout = 60000) {
    try {
        const fs = require('fs');
