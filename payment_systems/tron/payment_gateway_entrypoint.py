...
# -*- coding: utf-8 -*-
"""
File: /app/payment_systems/tron/payment_gateway_entrypoint.py
x-lucid-file-path: /app/payment_systems/tron/payment_gateway_entrypoint.py
x-lucid-file-type: python

Payment Gateway Service Entrypoint
...
site_packages = '/opt/venv/lib/python3.11/site-packages'  # Python 3.11 per documentation standard
app_dir = '/app'

# Add site-packages if not already in path
if site_packages not in sys.path:
    sys.path.insert(0, site_packages)

# Ensure app directory is in path (for importing main)
...
if __name__ == "__main__":
    ...
    port_str = os.getenv('SERVICE_PORT', os.getenv('PAYMENT_GATEWAY_PORT', '8097'))
