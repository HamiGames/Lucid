...
class TronNodeSystem:
    """TRON Node System for payment processing"""

    def __init__(self):
        self.service = TronService()

    def get_balance(self, address):
        return self.service.get_balance_sun(address)

    def transfer(self, from_key, to_address, amount):
        return self.service.transfer_sun(from_key, to_address, amount)
