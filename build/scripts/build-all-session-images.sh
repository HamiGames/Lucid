#!/bin/bash
# Build script for all Lucid Session Docker images
# Builds all session-related Docker images for ARM64 platform
...
echo "=========================================="
echo "Building All Lucid Session Docker Images"
echo "=========================================="
...
if [[ ${#FAILED_BUILDS[@]} -eq 0 ]]; then
    print_success "All Lucid Session Images Built Successfully!"
    echo "=========================================="
    echo ""
    ...
    echo ""
    print_status "Images are ready for deployment to Raspberry Pi"
    print_status "Use 'docker save' to export images for Pi deployment"
    echo ""
    print_success "Build completed: build-all-session-images.sh"
    exit 0
else
    ...
    echo ""
    print_error "Build completed with errors: build-all-session-images.sh"
    exit 1
fi
