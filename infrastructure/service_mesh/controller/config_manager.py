...
class ConfigManager:
    ...
    async def load_config(self):
        ...
        try:
            ...
            main_config_path = os.path.join(self.config_path, "service_mesh.yaml")
    ...
    def _setup_watch_paths(self):
        ...
        self.watch_paths = [
            os.path.join(self.config_path, "service_mesh.yaml"),
    ...
    async def _reload_config_file(self, file_path: str):
        ...
        try:
            if file_path.endswith("service_mesh.yaml"):
