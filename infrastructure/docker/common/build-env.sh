#!/bin/bash
# Path: /mnt/myssd/Lucid/Lucid/infrastructure/docker/common/build-env.sh
# Build Environment Script for Lucid common Services
# Generates .env files for common containers
...
SCRIPT_DIR="/mnt/myssd/Lucid/Lucid/infrastructure/docker/common"
