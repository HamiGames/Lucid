#!/bin/bash
# Path: /mnt/myssd/Lucid/Lucid/infrastructure/docker/databases/build-env.sh
# Build Environment Script for Lucid databases Services
# Generates .env files for databases containers
...
SCRIPT_DIR="/mnt/myssd/Lucid/Lucid/infrastructure/docker/databases"
...
log_info "Building environment files for Lucid databases Services"
