#!/bin/bash
# Path: /mnt/myssd/Lucid/Lucid/infrastructure/docker/rdp/build-env.sh
# Build Environment Script for Lucid rdp Services
# Generates .env files for rdp containers
...
SCRIPT_DIR="/mnt/myssd/Lucid/Lucid/infrastructure/docker/rdp"
