#!/bin/bash
# Path: /mnt/myssd/Lucid/Lucid/infrastructure/docker/payment-systems/build-env.sh
# Build Environment Script for Lucid payment-systems Services
# Generates .env files for payment-systems containers
...
SCRIPT_DIR="/mnt/myssd/Lucid/Lucid/infrastructure/docker/payment-systems"
...
log_info "Building environment files for Lucid payment-systems Services"
