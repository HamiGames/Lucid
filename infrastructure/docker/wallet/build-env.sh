#!/bin/bash
# Path: /mnt/myssd/Lucid/Lucid/infrastructure/docker/wallet/build-env.sh
# Build Environment Script for Lucid wallet Services
# Generates .env files for wallet containers
...
SCRIPT_DIR="/mnt/myssd/Lucid/Lucid/infrastructure/docker/wallet"
