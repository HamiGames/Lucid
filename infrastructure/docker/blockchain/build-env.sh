...
# File: /app/configs/docker//blockchain/build-env.sh
# x-lucid-file-path: /app/configs/docker//blockchain/build-env.sh
# x-lucid-file-directory: /app/configs/docker//blockchain
...
CONFIG_DIR="$LUCID_IMAGE_CONFIG_DIR"
...
GOVERNANCE_PATH=/app/lucid/governance
VOTING_PATH=/app/lucid/voting
PARAMETERS_PATH=/app/lucid/parameters
