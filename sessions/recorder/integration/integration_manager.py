...
try:
    ...
    # Add pipeline integration to path if needed
    pipeline_integration_path = Path(__file__).parent.parent.parent / 'pipeline' / 'integration'
...
class IntegrationManager:
    """
    Manages integration service clients for session-recorder
    ...
    def __init__(self, service_timeout: float = 30.0, service_retry_count: int = 3, service_retry_delay: float = 1.0):
        ...
        logger.info("Initializing IntegrationManager for session-recorder")
