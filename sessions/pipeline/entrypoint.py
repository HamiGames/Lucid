...
This script serves as the entrypoint for the session-pipeline container,
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"ERROR: Invalid SESSION_PIPELINE_PORT value: {port_str}", file=sys.stderr)
        sys.exit(1)
    
    # Import uvicorn and start the application
    import uvicorn
    uvicorn.run('pipeline.main:app', host=host, port=port)
