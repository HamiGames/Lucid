"""
File: /app/03_api_gateway/services/gui_bridge_service.py
x-lucid-file-path: /app/03_api_gateway/services/gui_bridge_service.py
...
class GuiBridgeService:
    ...
    Responsibilities:
    - Proxy requests to gui_api_bridge service
