...
1. **Deploy Layer 0** using `docker-compose -f infrastructure/compose/lucid-dev.yaml up -d`

1. **Deploy Layer 1** using `docker-compose -f infrastructure/compose/lucid-layer1-complete.yaml up -d`

1. **Deploy Layer 2** using `docker-compose -f infrastructure/compose/lucid-layer2-complete.yaml up -d`

1. **Or deploy all layers** using the main `infrastructure/compose/docker-compose.yaml` orchestrator
