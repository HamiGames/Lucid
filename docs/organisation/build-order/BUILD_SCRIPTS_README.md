...
2. **PowerShell 5.1+** or PowerShell Core
3. **Git** for version control
4. **Docker Hub account** with push permissions
...
4. Review the LUCID_DISTROLESS_BUILD_GUIDE.md for additional context
