...
class GuiHardwareManagerSettings(BaseSettings):
    ...
    SERVICE_NAME: str = Field(default="lucid-gui_hardware_manager", description="Service name")
    SERVICE_URL: str = Field(default="http://lucid-gui_hardware_manager:8099", description="Service URL for discovery")
