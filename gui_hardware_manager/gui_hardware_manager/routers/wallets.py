"""
File: /app/gui_hardware_manager/gui_hardware_manager/routers/wallets.py
x-lucid-file-path: /app/gui_hardware_manager/gui_hardware_manager/routers/wallets.py
